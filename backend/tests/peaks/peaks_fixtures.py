...
def mock_peaks_repository(mock_peaks_map, coords_map) -> PeaksRepository:
    ...
    async def get_nearest(
        ...
        if (latitude, longitude) == coords_map["near_rysy"]:
            results = [
                {"peak": mock_peaks_map["rysy"], "distance": 50.0},
                {"peak": mock_peaks_map["giewont"], "distance": 30000.0},
                {"peak": mock_peaks_map["babia_gora"], "distance": 80000.0},
            ]
        elif (latitude, longitude) == coords_map["near_sniezka"]:
            results = [
                {"peak": mock_peaks_map["giewont"], "distance": 150000.0},
                {"peak": mock_peaks_map["babia_gora"], "distance": 250000.0},
                {"peak": mock_peaks_map["rysy"], "distance": 400000.0},
            ]
        elif (latitude, longitude) == coords_map["warsaw"]:
            results = [
                {"peak": mock_peaks_map["babia_gora"], "distance": 250000.0},
                {"peak": mock_peaks_map["giewont"], "distance": 300000.0},
                {"peak": mock_peaks_map["rysy"], "distance": 400000.0},
            ]
